...
| 영역 | 설명 |
|---|---|
| **상단 메뉴** | 대 카테고리 탭 (전체 / AI 어시스턴트 / AI 창작 도구 / AI 개발 도구 / 플랫폼 & 리소스) |
| **사이드 메뉴** | 소 카테고리 필터 + 서비스 개수 표시 |
| **카드 그리드/리스트** | 서비스 아이콘 · 이름 · 설명 · 태그 · 방문 버튼 |
...
### UI / 디자인
- **다크/라이트 모드** — 시스템 설정 자동 감지, 수동 전환 가능 (설정 저장)
- **그리드/리스트 뷰** — `⊞` 그리드 또는 `≡` 리스트 뷰 전환
- **카드 밀도 조절** — 좁게 / 기본 / 넓게 선택
...
- HTML5 / CSS3 / Vanilla JavaScript (단일 파일, 외부 의존성 없음)
